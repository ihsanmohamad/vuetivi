   ...
   <div class="px-10 my-4 py-6 bg-gray-800 rounded-lg shadow-md">
      <div v-if="state.loading">
        ...
        <div v-else class="flex flex-wrap   space-y-4">
            <img alt="testimonial" class="inline-block object-cover object-center w-56 md:aspect-w-1  bg-gray-100 rounded" :src="state.show.image?.original ? state.show.image?.original : `https://static.tvmaze.com/images/no-img/no-img-landscape-text.png`" /> 
            <span class="flex flex-col flex-grow  space-y-3">
